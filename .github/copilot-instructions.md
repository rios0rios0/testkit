...
- **ALWAYS** write a changelog fragment with `chlog new --kind <Kind> --body "..."` and commit it from `.changes/unreleased/` -- CHANGELOG.md is generated from the fragments and is never edited by hand
